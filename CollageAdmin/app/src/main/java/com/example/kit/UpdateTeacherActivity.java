...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private void deleteData() {
        ...
        reference.child(category).child(uniqueKey).removeValue() //Jiska unique key match ho usko delete kr de
    ...
    private void checkValidation() {
            if(name.isEmpty()){
                updateTeacherName.setError("Error");
                updateTeacherName.requestFocus();

            }else  if(post.isEmpty()){
                updateTeacherPost.setError("Error");
                updateTeacherPost.requestFocus();

            } if(email.isEmpty()){
            updateTeacherEmail.setError("Error");
